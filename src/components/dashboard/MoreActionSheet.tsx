...
export const MoreActionSheet = ({ isOpen, onClose, link, onDelete, onDisable }: MoreActionSheetProps) => {
    ...
    return (
        <BottomSheet isOpen={isOpen} onClose={onClose} title="More Options">
            <div className="flex flex-col gap-0 pb-4">
                ...
                <button
                    onClick={() => {
                        // Analytics navigation will be handled locally or by parent wrapper, 
