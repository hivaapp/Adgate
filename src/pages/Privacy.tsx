...
export const Privacy = () => {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: 'AdGate works with ad networks for platform ads to help you monetize your content. These third-party advertisers may use cookies to deliver relevant ads and measure performance. Custom sponsor creatives are stored securely without injecting third-party trackers automatically.'
        },
        {
            id: 'cookies',
