...
import { FileIcon, ShieldAlert, Sparkles, User2 } from 'lucide-react';
                                ...
                                <div className="flex flex-col items-start truncate text-left w-full pr-2">
                                    ...
                                    <div className="flex items-center gap-2 overflow-hidden w-full">
                                        ...
                                        <div className="flex items-center gap-1 text-[12px] font-bold text-textLight">
                                            ...
                                            {link.adCount} Ad{link.adCount > 1 ? 's' : ''}
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div className="shrink-0 h-[40px] px-5 bg-text hover:bg-black text-white rounded-full font-black text-[13px] flex items-center justify-center relative z-10 transition-colors shadow-sm">
                                Unlock
                            </div>
                        </Link>
                    ))}
