...
export const Terms = () => {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: 'AdGate operates on a transparent revenue-sharing model. For platform ads, creators retain 95% of the total ad revenue generated, while AdGate keeps a 5% platform fee. For custom sponsor ads, you keep 100% of your negotiated deal and AdGate charges a 0% fee. Payouts are processed weekly via your connected Stripe account.'
        },
        {
